...
/// <summary>
/// Defines keys for accessing and querying data via Open F1.
/// </summary>
internal static class Keys
{
    public const string CircuitKey = "circuit_key";
    public const string CircuitShortName = "circuit_short_name";
